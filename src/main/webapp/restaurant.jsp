...
<body>
	...
	%>
	<%
	com.app.daoimpl.Cartimpl cart = (com.app.daoimpl.Cartimpl) session.getAttribute("cart");
	...
	<div class="main-wrap">
		...
		<section class="hero-wrapper">
			...
			<div class="hero-container-new">
				...
				<div class="hero-right">
					...
					<p class="hero-desc">Delicious Indian foods delivered fresh in
						under 30 minutes. Track orders live, pay easily, and enjoy premium
						experience.</p>

					<div class="hero-buttons">
						<a href="#restaurant"><button class="hero-order-btn">Order
								Now</button></a>
					</div>

					<div class="hero-badges">
						<span class="hero-badge">🍽 4000+ Restaurants</span> <span
							class="hero-badge">📍 Live Tracking</span> <span
							class="hero-badge">🛡 Safe & Hygienic</span>
					</div>
				</div>
		...
		<div class="food-section">
			...
			<div class="cat-wrapper">
				...
				<div class="cat-slider" id="slider">
					<!-- 1 -->
					<div class="cat-card">
						<img src="Image/cat-briyani-removebg-preview.png" alt=""> <span>Biryani</span>
					</div>

					<!-- 2 -->
					<div class="cat-card">
						<img src="Image/cat-fried.png" alt=""> <span>Fried
							Rice</span>
					</div>

					<!-- 3 -->
					<div class="cat-card">
						<img src="Image/cat-itly-removebg-preview.png" alt=""> <span>Idly
							& Dosa</span>
					</div>

					<!-- 4 -->
					<div class="cat-card">
						<img src="Image/cat-paratto.webp" alt=""> <span>Parotta</span>
					</div>

					<!-- 5 -->
					<div class="cat-card">
						<img src="Image/cat-cake-removebg-preview.png" alt=""> <span>Cakes</span>
					</div>

					<!-- 6 -->
					<div class="cat-card">
						<img src="Image/cat-pizza-removebg-preview.png" alt=""> <span>Pizza</span>
					</div>

					<!-- 7 -->
					<div class="cat-card">
						<img src="Image/cat-role.webp" alt=""> <span>Rolls</span>
					</div>
		...
		<div class="no-results-wrapper" id="noResultsBox">
			<div class="no-result-card">
				...
				<div class="no-result-sub">Try a different spellings like
					“biryani”, “pizza”, “dosa” or “burger”.</div>
			</div>
		</div>
		...
		<div class="load-more-wrapper">
			<button id="loadMoreBtn" class="load-more-btn">
				<span class="btn-text">Show more</span> <span class="loader"></span>
			</button>
		</div>
		...
		<section class="app-strip">
			<div>
				...
				<p>Track orders live, unlock app-only offers and re-order in one
					tap.</p>
			</div>
	...
	<footer class="footer">
		<div class="footer-container">
			...
			<div class="footer-col">
				<h3>Company</h3>
				<a href="#">About Us</a> <a href="#">Corporate</a> <a href="#">Careers</a>
				<a href="#">Team</a> <a href="#">Feasto One</a> <a href="#">Instant</a>
				<a href="#">Dineout</a>
			</div>
			...
			<div class="footer-col">
				<h3>Contact us</h3>
				<a href="#">Help & Support</a> <a href="#">Partner with us</a> <a
					href="#">Ride with us</a>

				<h3 style="margin-top: 20px;">Legal</h3>
				<a href="#">Terms & Conditions</a> <a href="#">Cookie Policy</a> <a
					href="#">Privacy Policy</a> <a href="#">Investor Relations</a>
			</div>

			<!-- CITIES -->
			<div class="footer-col">
				<h3>Available in:</h3>
				<a href="#">Bangalore</a> <a href="#">Gurgaon</a> <a href="#">Hyderabad</a>
				<a href="#">Delhi</a> <a href="#">Mumbai</a> <a href="#">Pune</a>
			...
			<div class="footer-col">
				...
				<a href="#">Explore with Feasto</a> <a href="#">Feasto News</a> <a
					href="#">Snackables</a>
				...
				<div class="social-icons">
					<i class="fa-brands fa-linkedin"></i> <i
						...
						class="fa-brands fa-pinterest"></i> <i
